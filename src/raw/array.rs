...
/// Guard for incremental initialization of arrays.
///
/// # Safety
///
/// All write accesses to this structure are unsafe and must maintain a correct
/// count of `initialized` elements.
pub(crate) struct ArrayGuard<T, const N: usize> {
...
impl<T, const N: usize> ArrayGuard<T, N> {
    ...
    /// Converts [`ArrayGuard`] into [`ArrayIter`]
    #[inline]
    pub(crate) fn into_iter(self) -> ArrayIter<T, N> {
